 ...
 *
 * 用于登录页、注册页等无需登录的页面
 * 本地版本已去除激活码/续期等作者商业化入口
 */
import { Link, useLocation } from 'react-router-dom'
import { useState, useEffect } from 'react'
import { Home, Monitor, Menu, X, MessageSquare, Code2, Sun, Moon } from 'lucide-react'
...
/** 本地版本不区分线上环境（原实现会判断作者域名），恒为 false */
const isOnlineEnv = () => {
  return false
}

/** 导航菜单项定义（本地版本已去除激活码/续期等作者商业化入口） */
const NAV_ITEMS = [
