...
class BackendWebConfig(BaseConfig):
    ...
    # 本地版本默认不指向任何作者服务器，需使用时通过环境变量 CARD_DOCK_BASE_URL 配置
